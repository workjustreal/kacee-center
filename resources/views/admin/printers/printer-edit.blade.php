@extends('layouts.master-layout', ['page_title' => "แก้ไขเครื่องพิมพ์"])
@section('css')
<!-- third party css -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">แก้ไขเครื่องพิมพ์</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-box">
                        <form class="form-horizontal" action="{{ route('printer.update') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="mb-3">
                                @if ($errors->any())
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select form-control-required" id="type" name="type" required>
                                    ...
                                    <option value="label" @if ($data->type=='label') selected @endif>เครื่องพิมพ์ Label</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="client_ip" class="form-label">ไอพีเครื่อง PC</label>
                                <input id="client_ip" name="client_ip" type="text" class="form-control" value="{{ $data->client_ip }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="radio radio-success form-check-inline ml-2">
                                    <input type="radio" id="role1" value="1" name="role" checked {{ ($data->role==1) ? 'checked' : '' }} required>
                                    <label for="role1">Admin </label>
                                </div>
                                <div class="radio radio-success form-check-inline">
                                    <input type="radio" id="role2" value="2" name="role" {{ ($data->role==2) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="radio radio-success form-check-inline ml-2">
                                    <input type="radio" id="status1" value="1" name="status" checked {{ ($data->status==1) ? 'checked' : '' }} required>
                                    <label for="status1">ใช้งาน </label>
                                </div>
                                <div class="radio form-check-inline">
                                    <input type="radio" id="status2" value="0" name="status" {{ ($data->status==0) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3 d-flex justify-content-between">
                                ...
                                <input type="hidden" id="user_olddata" name="user_olddata" class="form-control" value="{{ $users }}" />
