@extends('layouts.master-layout', ['page_title' => "เพิ่มสิทธิ์ระบบงาน"])
@section('css')
<!-- third party css -->
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">เพิ่มสิทธิ์ระบบงาน</li>
                    </ol>
                </div>
                <h4 class="page-title">เพิ่มสิทธิ์ระบบงาน</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-box">
                        <form action="{{ route('app-permission.store') }}" class="wow fadeInLeft" method="POST"
