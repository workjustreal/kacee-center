@extends('layouts.master-layout', ['page_title' => "แก้ไขสิทธิ์การใช้งาน"])
@section('css')
<!-- third party css -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">แก้ไขสิทธิ์การใช้งาน</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                ...
                <div class="card-body">
                    <div class="card-box">
                        <form class="form-horizontal" action="{{ route('permission.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" class="form-control" id="id" name="id" value="{{ $permission->id }}" required />
                            <div class="mb-3">
