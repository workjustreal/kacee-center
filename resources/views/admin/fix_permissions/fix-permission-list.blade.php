@extends('layouts.master-layout', ['page_title' => "จัดการสิทธิ์การใช้งานเฉพาะทาง"])
@section('css')
<!-- third party css -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">จัดการสิทธิ์การใช้งานเฉพาะทาง</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <div class="row justify-content-between mb-2">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-2 text-sm-end">
                                <a href="{{url('/admin/fix-permissions/create')}}" class="btn btn-primary waves-effect waves-light">
...
<script type="text/javascript">
    ...
    function ajaxRequest(params) {
        var url = "{{ url('admin/fix-permissions/search') }}";
    ...
    function deleteFixPermissionConfirmation(id) {
        Swal.fire({
            ...
            preConfirm: () => {
                return fetch(`{{ url('admin/fix-permissions/del') }}/` + id)
                    .then((response) => {
                        if (!response.ok) {
