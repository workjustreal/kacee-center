@extends('layouts.master-layout', ['page_title' => "แก้ไขสิทธิ์การใช้งานเฉพาะทาง"])
@section('css')
<!-- third party css -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">แก้ไขสิทธิ์การใช้งานเฉพาะทาง</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-box">
                        <form class="form-horizontal" action="{{ route('fix-permission.update') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="mb-3">
                                @if ($errors->any())
                            ...
                            <input type="hidden" class="form-control" id="permission_id" name="permission_id" value="{{ $permission->id }}" required />
                            <div class="mb-3">
                                ...
                                <input id="permission" name="permission" type="text" class="form-control" value="{{ $permission->permission }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" placeholder="รายละเอียดสิทธิ์"
                                    name="description" rows="4" required>{{ $permission->description }}</textarea>
                            </div>
                            <div class="row mt-3">
