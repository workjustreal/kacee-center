@extends('layouts.master-layout', ['page_title' => "เพิ่มบทบาท"])
@section('css')
<!-- third party css -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">เพิ่มบทบาท</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <div class="card-box">
                        <form class="form-horizontal" action="{{ route('role.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="role" name="role" type="text" class="form-control" value="{{ old('role') }}"
