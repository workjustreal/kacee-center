@extends('layouts.master-layout', ['page_title' => "ประวัติบันทึกวันทำงาน"])
@section('css')
<!-- third party css -->
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">ประวัติบันทึกวันทำงาน</li>
                    </ol>
                </div>
                <h4 class="page-title">ประวัติบันทึกวันทำงาน</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
...
<script type="text/javascript">
    ...
    function ajaxRequest(params) {
        var url = "{{ url('leave/rw-history/search') }}";
