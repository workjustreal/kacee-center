@extends('layouts.master-layout', ['page_title' => "สร้างงวดค่าแรงใหม่"])
@section('css')
<!-- third party css -->
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">สร้างงวดค่าแรงใหม่</li>
                    </ol>
                </div>
                <h4 class="page-title">สร้างงวดค่าแรงใหม่</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-box">
                        <form action="{{ route('period-salary.store') }}" class="wow fadeInLeft" method="POST"
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-required custom-datepicker" id="start" name="start" required>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-required custom-datepicker" id="end" name="end" required>
                                        <span class="input-group-text"><i class="fe-calendar"></i></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control custom-datepicker" id="last" name="last">
                                        <span class="input-group-text"><i class="fe-calendar"></i></span>
                                    </div>
                                </div>
                            </div>
