            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-auto col-sm-12 mb-2">
                            <label for="leave_date" class="form-label mb-0">วันที่ลา</label>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-sm pt-1" id="leave_date" name="leave_date" placeholder="กรอกวันที่">
                            </div>
                        </div>
                        <div class="col-md-auto col-sm-12 mb-2">
                            <label for="record_date" class="form-label mb-0">วันที่บันทึก</label>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-sm pt-1" id="record_date" name="record_date" placeholder="กรอกวันที่">
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="table"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-field="leave_manage" data-force-hide="true" data-visible="false" data-print-ignore="true">จัดการ</th>
                            </tr>
                        </thead>
                    </table>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#leave_date").flatpickr({
            ...
            onClose: function(selectedDates, dateStr, instance) {
                $table.bootstrapTable('refreshOptions', {leave_date: dateStr});
            },
        });
        $("#record_date").flatpickr({
            ...
            onClose: function(selectedDates, dateStr, instance) {
                $table.bootstrapTable('refreshOptions', {record_date: dateStr});
            },
        });
        setTimeout(() => {
    ...
    function queryParams(params) {
        ...
        params.leave_date = $("#leave_date").val();
        params.record_date = $("#record_date").val();
        $('button[name="print"]').html('<i class="dripicons-print mt-1"></i>');
        $('div.export > button').html('<i class="dripicons-download mt-1"></i>');
        return params;
    }
    function ajaxRequest(params) {
        var url = "{{ url('leave/manage/emp-leave-history/search') }}";
