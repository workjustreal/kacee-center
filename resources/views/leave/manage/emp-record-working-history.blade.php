            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-auto col-sm-12 mb-2">
                            <label for="work_date" class="form-label mb-0">วันที่มาทำงาน</label>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-sm pt-1" id="work_date" name="work_date" placeholder="กรอกวันที่">
                            </div>
                        </div>
                        <div class="col-md-auto col-sm-12 mb-2">
                    ...
                    <table id="table"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-field="manage" data-force-hide="true" data-visible="false" data-print-ignore="true">จัดการ</th>
                            </tr>
                        </thead>
                    </table>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#work_date").flatpickr({
            ...
            onClose: function(selectedDates, dateStr, instance) {
                $table.bootstrapTable('refreshOptions', {work_date: dateStr});
            },
        });
    ...
    function customSearch(data, text) {
        return data.filter(function (row) {
            ...
            for (const [key, value] of Object.entries(row)) {
                chk += (value !== null) ? (value.toString().toLowerCase().replace(/<\/?[^>]+(>|$)/g, "").indexOf(text.toLowerCase()) > -1) ? 1 : 0 : 0;
            }
            if (chk > 0) {
                return true;
            }
    ...
    function ajaxRequest(params) {
        var url = "{{ url('leave/manage/emp-record-working-history/search') }}";
