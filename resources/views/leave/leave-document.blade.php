@extends('layouts.master-layout', ['page_title' => "ใบลางาน"])
@section('css')
<style>
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">ใบลางาน</li>
                    </ol>
                </div>
                <h4 class="page-title">ใบลางาน</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <div class="track-order-list">
                        <ul class="list-unstyled">
                            ...
                            <li class="{{ $cancel1 }}">
                                ...
                                <p class="text-muted">&nbsp;</p>
                                @endif
                                <span class="text-muted">{{ $leave->leave_cancel_remark }}</span>
                            </li>
                            @elseif ($leave->leave_status == "C2")
                            <li class="{{ $cancel2 }}">
                                {!! $cancel2Active !!}
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <a href="{{ url('/leave/document-record-working/'.$rwRef->id) }}" class="text-primary"><i class="mdi mdi-file-document-outline me-1"></i>ใบบันทึกวันทำงาน</a>
                                </div>
                            </div>
                        </div>
                        @endif
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3 pb-4">
                        <div class="col-sm-12">
                            ...
                            <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;<span class="text-dark">{{ $leave->leave_reason }}</span>&nbsp;&nbsp;&nbsp;</span>
                            @if ($leave->leave_reason_hr != "")
                            <br><span>หมายเหตุจากบุคคล</span>
                            <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;<span class="text-dark">{{ $leave->leave_reason_hr }}</span>&nbsp;&nbsp;&nbsp;</span>
                            @endif
                            @else
                            ...
                            @if ($leave->leave_reason_hr != "")
                            <br><div class="rtv mt-2">
                                <div class="full-underline abs">
                                    <span class="full-dotted mb-2"><span class="bg-white">หมายเหตุจากบุคคล</span><span class="text-dark px-3">{{ $leave->leave_reason_hr }}</span></span>
                                </div>
                            </div>
                            @endif
                            @endif
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="printLeaveModalLabel">พิมพ์ใบลางาน</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <embed src="{{ url('leave/document/pdf', $leave->leave_id) }}" frameborder="0" width="100%" height="600px">
                </div>
            </div>
        </div>
    </div>
