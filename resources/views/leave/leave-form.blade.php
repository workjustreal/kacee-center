        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="card-box">
                            <form action="{{ route('leave.store') }}" class="wow fadeInLeft" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-12">
                                            <div class="input-group mb-3">
                                                ...
                                                @endif
                                                <input type="text" class="form-control" id="leave_reason" name="leave_reason" value="{{ old('leave_reason') }}" placeholder="เหตุผลที่ขอหยุดงาน">
                                            </div>
                                        </div>
                                    </div>
