        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แก้ไขใบลาให้พนักงาน</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="card-box">
                            <form action="{{ route('approve-hr.emp-leave-update') }}" class="wow fadeInLeft" method="POST"
                                ...
                                <div class="p-lg-3">
                                    <div class="row mb-1">
                                        <div class="d-flex align-items-start mb-2 mt-1">
                                            <img class="d-flex me-2 rounded-circle" src="{{url('assets/images/users/thumbnail/'.$user->image)}}" onerror="this.onerror=null;this.src='{{url('assets/images/users/thumbnail/user-1.jpg')}}';" alt="placeholder image" height="32">
                                            <div class="w-100">
                                    ...
                                    <div class="mb-3" id="formfile" @if ($leave->leave_type_id!=2) hidden @endif>
                                        ...
                                        <div id="link_attach_file_old">
                                            <a href="{{ url('/leave/attach/'.$leave->leave_attach) }}" target="_blank" class="text-primary"><span class="badge badge-soft-primary rounded-pill fs-6 mt-1"><i class="mdi mdi-attachment me-1"></i> {{ $leave->leave_attach }}</span></a><span class="badge badge-soft-danger ms-1" role="button" title="ลบไฟล์" onclick="$('#attach_file_old').val('');$('#link_attach_file_old').html('');"><i class="mdi mdi-trash-can"></i></span>
                                        </div>
                                        @endif
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-12">
                                            <div class="input-group mb-3">
                                                ...
                                                @endif
                                                <input type="text" class="form-control" id="leave_reason" name="leave_reason" placeholder="เหตุผลที่ขอหยุดงาน" value="{{ $leave->leave_reason }}">
                                            </div>
                                            <div class="input-group mb-3">
                                                @if((new \Jenssegers\Agent\Agent())->isDesktop() || (new \Jenssegers\Agent\Agent())->isTablet())
                                                <span class="input-group-text text-pink bg-soft-pink border-pink">หมายเหตุจากบุคคล</span>
                                                @endif
                                                <input type="text" class="form-control" id="leave_reason_hr" name="leave_reason_hr" placeholder="หมายเหตุจากบุคคล" value="{{ $leave->leave_reason_hr }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" class="form-control" id="emp_id" name="emp_id" value="{{ $leave->emp_id }}">
                                    <input type="hidden" class="form-control" id="dept_id" name="dept_id" value="{{ $user->dept_id }}">
                                    <input type="hidden" class="form-control" id="leader_id" name="leader_id" value="{{ $leave->leader_id }}">
                                    ...
                                    <div class="mt-4">
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ url('leave/approve-hr/leave-approve') }}" class="btn btn-soft-secondary waves-effect waves-light"><i class="mdi mdi-keyboard-backspace me-1"></i> ย้อนกลับ</a>
...
@section('script')
    ...
    <script src="{{ asset('assets/js/pages/form-hr-leave.init.js') }}"></script>
    <!-- third party js ends -->
@endsection