            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="mt-4 mb-1">
                        ...
                        <div class="text-end">
                            <button type="button" class="btn btn-primary waves-effect waves-light" onclick="approveConfirmation('{{ $leave->id }}');"><i class="mdi mdi-check-bold me-1"></i> อนุมัติ</button>
