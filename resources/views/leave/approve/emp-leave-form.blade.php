@extends('layouts.master-layout', ['page_title' => 'ลางาน'])
@section('css')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ลางาน</li>
                        </ol>
                    </div>
                    <h4 class="page-title">ลางานให้พนักงาน</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="card-box">
                            <form action="{{ route('approve.emp-leave-store') }}" class="wow fadeInLeft" method="POST"
                            enctype="multipart/form-data" onsubmit="return SubmitForm(this);">
                            {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-5">
                                        <h4 class="text-info">กรอกใบลา</h4>
                                    </div>
                                    <div class="col-7">
                                ...
                                <div class="p-lg-3">
                                    ...
                                    <div class="alert alert-warning" id="leave_type_detail" role="alert" hidden></div>
                                    <div class="mb-3" id="formfile" hidden>
                                    ...
                                    <div class="row">
                                                ...
                                                @foreach ($leave_type as $list)
                                                    @if ($list->leave_type_id == "9") // ลาคลอด
                                                        ...
                                                        <option value="{{ $list->leave_type_id }}" title="{{ $list->leave_type_detail }}"
                                                            @if ($list->leave_type_id==old('leave_type')) selected @endif>{{ $list->leave_type_name }}</option>
                                                        @endif
                                        ...
                                        <div class="col-md-7 col-12">
                                            <div class="input-group mb-3">
                                                ...
                                                @endif
                                                <input type="text" class="form-control" id="leave_reason" name="leave_reason" value="{{ old('leave_reason') }}">
                                            </div>
                                        </div>
                                    </div>

                                    <div id="record_working_detail_use"></div>
                                    <div id="record_working_detail"></div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check form-check-inline range_full">
                                                <input class="form-check-input" type="radio" name="leave_range"
                                                    id="full" value="full" checked @if ("full"==old('leave_range')) checked @endif required>
                                                <label class="form-check-label" for="full">ลาเต็มวัน</label>
                                            </div>
                                            <div class="form-check form-check-inline range_many">
                                                <input class="form-check-input" type="radio"
                                                    name="leave_range" id="many" value="many" @if ("many"==old('leave_range')) checked @endif>
                                                <label class="form-check-label" for="many">ลามากกว่า 1 วัน</label>
                                            </div>
                                            <div class="form-check form-check-inline range_etc">
                                                <input class="form-check-input" type="radio"
                                                    name="leave_range" id="etc" value="etc" @if ("etc"==old('leave_range')) checked @endif>
                                        ...
                                        <div class="col-lg-5 col-md-5 col-12">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control leave-datepicker" id="date_start" name="date_start"
                                                    placeholder="กรอกวันที่" value="{{ old('date_start') }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-7 col-md-7 col-12">
                                            <div class="row">
                                                <div class="col-lg-9 col-md-7 col-12">
                                                    <div class="input-group mb-3 sum_day" hidden>
                                                        ...
                                                        <input type="text" class="form-control leave-datepicker"
                                                            id="date_end" name="date_end" value="{{ old('date_end') }}" placeholder="กรอกวันที่">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-5 col-12">
                                                    <div class="input-group mb-3 sum_day" hidden>
                                                        <input type="number" class="form-control" id="sum_day" name="sum_day" value="{{ old('sum_day') }}" autocomplete="off" min="0" max="999" onblur="if(this.value<=0){this.value=0}" onkeypress="return onlyNumberKey(event)">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-12">
                                            <div class="input-group mb-3 hour" hidden>
                                                <span class="input-group-text text-info bg-soft-info border-info">เวลาเริ่ม</span>
                                                <input type="text" id="time_start" name="time_start" value="{{ old('time_start') }}" class="form-control hour 24hours-timepicker" placeholder="00:00">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-12">
                                            <div class="input-group mb-3 hour" hidden>
                                                <span class="input-group-text text-info bg-soft-info border-info">ถึง</span>
                                                <input type="text" id="time_end" name="time_end" value="{{ old('time_end') }}" class="form-control 24hours-timepicker" placeholder="00:00">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-12">
                                            <div class="input-group mb-3 hour" hidden>
                                                <select class="form-select" id="sum_hour" name="sum_hour">
                                                    @for ($i=0; $i<=7; $i++)
                                                    <option value="{{ $i }}" @if ($i==old('sum_hour')) selected @endif>{{ $i }}</option>
                                                    @endfor
                                                </select>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            <div class="input-group mb-3 hour" hidden>
                                                <select class="form-select" id="sum_minute" name="sum_minute">
                                                    <option value="0" @if ("0"==old('sum_minute')) selected @endif>0</option>
                                                    <option value="30" @if ("30"==old('sum_minute')) selected @endif>30</option>
                                                </select>
                                    ...
                                    <input type="hidden" class="form-control" id="emp_id" name="emp_id" value="{{ $user->emp_id }}">
                                    ...
                                    <div class="mt-4">
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ url('leave/approve/dashboard') }}" class="btn btn-soft-secondary waves-effect waves-light"><i class="mdi mdi-keyboard-backspace me-1"></i> ย้อนกลับ</a>
                                            <button type="submit" class="btn btn-soft-primary waves-effect waves-light"><i class="mdi mdi-content-save me-1"></i>บันทึกใบลา</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
