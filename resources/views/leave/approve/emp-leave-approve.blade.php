                ...
                <div class="card-body">
                    ...
                    <div class="track-order-list">
                        ...
                        <div class="text-center mt-4">
                            <a href="#" class="btn btn-primary">ข้อมูลการลางาน</a>
                        </div>
                    </div>
            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="float-end">
                            {{-- <a href="{{ url('leave/approve/emp-leave-edit', $leave->leave_id) }}" class="btn btn-warning me-2"><i class="mdi mdi-lead-pencil me-1"></i> แก้ไขใบลา</a> --}}
