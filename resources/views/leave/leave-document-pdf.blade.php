@extends('layouts.pdf-layout', ['page_title' => "ใบลางาน"])
@section('content')
@php
...
<table class="table-leave" width="100%">
    <tbody>
        ...
        <tr>
            <td colspan="2" class="text-center"><b><u>ใบลา</u></b></td>
        </tr>
    </tbody>
</table>
<div class="text-end">
...
<div style="margin-top: 80px;">
    <div style="float: left;width: 15%;height: 80px;">มีความประสงค์ขอ</div>
    <div style="width: 85%;margin-top: 12px;">
        <div class="row">
            ...
            <div class="column-three">
                ...
                @else
                <img src="data:image/png;base64,{{ base64_encode(file_get_contents($base_url . '/assets/images/checkbox.png')) }}" height="14">
                @endif
                <span>{{ $list->leave_type_name }}</span>
            </div>
            @php
                if ($i == 4) {
                    $i = 0;
...
<div>
    ...
    <span>ลาวันที่</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ \Carbon\Carbon::parse($leave->leave_start_date)->format('d') }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>เดือน</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ \Carbon\Carbon::parse($leave->leave_start_date)->locale('th_TH')->isoFormat('MMMM') }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>พ.ศ.</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ (\Carbon\Carbon::parse($leave->leave_start_date)->format('Y') + 543) }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    @if ($leave->leave_range == "etc")
    <span>เวลา</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ \Carbon\Carbon::parse($leave->leave_start_time)->format('H:i') }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>ถึง เวลา</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ \Carbon\Carbon::parse($leave->leave_end_time)->format('H:i') }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>รวม</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>@if($leaveMinutes['h']>0) {{ $leaveMinutes['h'].' ชม. ' }} @endif @if($leaveMinutes['m']>0) {{ $leaveMinutes['m'].' น.' }} @endif</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    @endif
    @else
    <span>ลาตั้งแต่วันที่</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ \Carbon\Carbon::parse($leave->leave_start_date)->format('d') }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>เดือน</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ \Carbon\Carbon::parse($leave->leave_start_date)->locale('th_TH')->isoFormat('MMMM') }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>พ.ศ.</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ (\Carbon\Carbon::parse($leave->leave_start_date)->format('Y') + 543) }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span class="bg-white px-1">ถึง วันที่</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ \Carbon\Carbon::parse($leave->leave_end_date)->format('d') }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>เดือน</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ \Carbon\Carbon::parse($leave->leave_end_date)->locale('th_TH')->isoFormat('MMMM') }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>พ.ศ.</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ (\Carbon\Carbon::parse($leave->leave_end_date)->format('Y') + 543) }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>รวม</span>
    <span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ $leave->leave_day }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>วัน</span>
    @endif
    @if ($rwRef)
    <span>แทนวันที่</span>
...
<div class="row mt-4">
    <div class="column-two">
        <span>ลงชื่อ</span><span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>@if (count($leaveLeader)) {{ $leaveLeader['name'] }} @endif</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span>ผู้บันทึก</span>
    </div>
    <div class="column-two text-end">
        <span>ลงชื่อ</span><span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>@if (count($leaveEmp)) {{ $leaveEmp['name'] }} @endif</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span>ผู้ลา</span>
    </div>
</div>
@else
