                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3 pb-4">
                        <div class="col-sm-12">
                            ...
                            <br><span class="text-decoration-dotted">&nbsp;&nbsp;&nbsp;<span class="text-dark">{{ $leave->leave_reason_hr }}</span>&nbsp;&nbsp;&nbsp;</span>
                            @endif
                            @else
                    ...
                    <div class="mt-4 mb-1">
                        <div class="text-end d-print-none">
                            ...
                            <a href="{{ url('leave/document/pdf', $leave->leave_id) }}" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-download me-1"></i> ดาวน์โหลด</a>
                        </div>
                    </div>
                </div>
            </div>
