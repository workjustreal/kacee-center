                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Special Dsicount</a></li>
                    ...
                    <div class="card-body">
                        @foreach ($result as $req)
                            <form class="form-horizontal" method="post" enctype="multipart/form-data" id="request_update"
                                action="{{ route('special.update.Request', [$req->doc_id, $req->id, $req->doc_status]) }}">
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-lg-12 mt-3">
                                        <div class="fom-group">
                                            ...
                                            <textarea class="form-control form-control-md form-control-required" id="description" name="description"
                                                placeholder="..." rows="15">{{ strip_tags($req->description) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                @if ($ck_again == 'true')
                                        ...
                                        @if ($img != '')
                                            @foreach ($img as $img)
                                                <div class="col-2 mt-2">
                                                    <img src="{{ asset('assets/images/special/' . $img) }}"
