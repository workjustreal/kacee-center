                ...
                <div class="card">
                    <div class="card-body">
                        @foreach ($result as $detail)
                            ...
                            @endif
                            <h5 class="text-center mb-3"><b><u>ใบคำขอส่วนลดงานล็อตใหญ่</u></b></h5>
                            <div class="card border ribbon-custom-box">
                                <div class="card-header">
                                    แบบฟอร์มขออนุมัติส่วนลดงานล็อตใหญ่
                                </div>
                                <div class="card-body">
                                        ...
                                        @foreach ($img as $key => $valimg)
                                            <div class="col-6 col-lg-2">
                                                <a href="javascript:void(0)">
                                                    <img src="{{ asset('assets/images/special/' . $valimg) }}"
                                                        class="w-100" alt="special image" title="special image"
                                                                ...
                                                                <div class="carousel-inner">
                                                                    @foreach ($img as $index => $slide)
                                                                        <div
                                                                            ...
                                                                            <a href="{{ asset('assets/images/special/' . $slide) }}"
                                                                                target="_blank">
                                                                                <img src="{{ asset('assets/images/special/' . $slide) }}"
                                                                                    class="d-block w-100"
                                                                                    alt="special image">
                                                                            </a>
                                                                        </div>
                                ...
                                <div class="card-body">
                                                    ...
                                                    @foreach ($imgmn as $key => $mnval)
                                                        <div class="col-6 col-lg-2">
                                                            {{-- <a href="javascript:void(0)" data-bs-toggle="modal"
                                                                data-bs-target="#mnfile{{ $loop->index }}">
                                                                <img src="{{ asset('assets/images/special/' . $mnval) }}"
                                                                    class="w-100" alt="special image"
                                                                    title="special image">
                                                            ...
                                                            <a href="javascript:void(0)">
                                                                <img src="{{ asset('assets/images/special/' . $mnval) }}"
                                                                    class="w-100" alt="special image"
                                                                    title="special image" data-bs-toggle="modal"
                                                                        ...
                                                                        <div id="slideMn{{ $key }}"
                                                                            ...
                                                                            <div class="carousel-inner">
                                                                                @foreach ($imgmn as $index => $slideMn)
                                                                                    <div
                                                                                        class="carousel-item {{ $index == $key ? 'active' : '' }}">
                                                                                        <a href="{{ asset('assets/images/special/' . $slideMn) }}"
                                                                                            target="_blank">
                                                                                            <img src="{{ asset('assets/images/special/' . $slideMn) }}"
                                                                                                class="d-block w-100"
                                                                                                alt="special image">
                                                                                        </a>
                                                                                    </div>
                                    ...
                                    @if ($status == 2)
                                        <form class="form-horizontal" method="post" id="managerForm"
                                            ...
                                            action="{{ route('special.managerApprove', [$detail->doc_id, $detail->id]) }}">
                                            {{ csrf_field() }}
                                        ...
                                        <form action="{{ route('special.image.request') }}" method="POST"
...
@section('script')
    ...
    <script>
        ...
        function secretaryApprove(doc_id, id, approve) {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    ...
                    return fetch(
                            '/sales-document/special-discount/approve/secretary-approve', {
                                method: 'POST',
                                headers: {
                ...
                if (result.isConfirmed) {
                    ...
                    setTimeout(() => {
                        location.href =
                            "{{ url('/sales-document/special-discount/secretary-approve') }}";
                    }, 2000);
                }
            });
        }
        ...
        $("#btnPrint").click(function() {
            ...
            $("#pdf").attr("src", "{{ url('sales-document/special-discount/print') }}/" + objData
                .toString());

            $.ajax({
                type: 'POST',
                url: "{{ route('special.log.print') }}",
                data: {
                    doc_id: $(this).val(),
                },
