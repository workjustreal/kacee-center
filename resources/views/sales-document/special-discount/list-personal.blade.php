@extends('layouts.master-layout', ['page_title' => 'รายการขอส่วนลดงานล็อตใหญ่'])
@section('css')
    <!-- third party css -->
...
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">รายการขอส่วนลดงานล็อตใหญ่</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <form method="get" action="{{ route('special.list.personal') }}">
                                {{ csrf_field() }}
                                <div class="row">
                            ...
                            <div>
                                <a href="{{ url('/sales-document/special-discount/request') }}" type="button"
                                                ...
                                                @if (auth()->user()->emp_id == $dis->emp_id)
                                                    @if ($dis->doc_status == 2 || $dis->doc_status == 3 || $dis->doc_status == 0)
                                                        @if ($noedit == '' || $dis->doc_status == 2)
                                                            <a
                                                                href="{{ url('sales-document/special-discount/edit') }}/{{ $dis->doc_id }}/{{ $dis->id }}/{{ $dis->doc_status }}">
    ...
    <div id="printModal" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="printModalLabel">แบบฟอร์มขออนุมัติส่วนลดงานล็อตใหญ่</h4>
        ...
        function deleteRequest(doc_id, id) {
            Swal.fire({
                ...
                preConfirm: () => {
                    ...
                    return fetch('/sales-document/special-discount/delete/', {
                            method: 'POST',
                            headers: {
