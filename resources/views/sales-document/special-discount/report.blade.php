@extends('layouts.master-layout', ['page_title' => 'รายงานขอส่วนลดงานล็อตใหญ่'])
@section('css')
    <!-- third party css -->
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Specail Discount</li>
                        </ol>
                    </div>
                    <h4 class="page-title">รายงานขอส่วนลดงานล็อตใหญ่</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                        ...
                                        <tr>
                                            <td>
                                                <a class="btn btn-outline-primary waves-effect waves-light"
                                                    href="{{ url('sales-document/special-discount/report-preview/view') }}/{{ $dis->doc_id }}/{{ $dis->doc_status }}">
                                                    {{ $dis->doc_id }}
                                                </a>
                                            </td>
