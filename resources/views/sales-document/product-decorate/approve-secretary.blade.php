                                ...
                                @foreach ($decorate as $dis)
                                    @if ($dis->doc_status != 1)
                                        ...
                                        <tr>
                                            <td>
                                                <a class="btn btn-outline-primary waves-effect waves-light"
                                                    href="{{ url('sales-document/product-decorate/preview/view') }}/{{ $dis->doc_id }}/{{ $dis->doc_status }}">
                                                    {{ $dis->doc_id }}
                                                </a>
                                            </td>
                                            <td><i class="fe-clock"></i>
                                            ...
                                            <td><a
                                                ...
                                                @if ($dis->doc_status == 1)
                                                    <a href="javascript: void(0);"
                                                        onclick="approve('{{ $dis->doc_id }}',{{ $dis->id }},'yes')">
                                                        <i class="mdi mdi-check-circle-outline fs-4 text-success"
                                                            title="อนุมัติ"></i>&nbsp;
                                                    </a>
                                                    <a href="javascript: void(0);"
                                                        onclick="approve('{{ $dis->doc_id }}',{{ $dis->id }},'no')">
                                                        <i class="mdi mdi-close-circle-outline fs-4 text-danger"
                                                            title="ไม่อนุมัติ"></i>
                                                    </a>
                                                @endif
