@extends('layouts.master-layout', ['page_title' => 'รายงานขอสินค้าตกแต่งหน้าร้าน'])
@section('css')
    <!-- third party css -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">รายงานขอสินค้าตกแต่งหน้าร้าน</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <form method="get" action="{{ route('decorate.report') }}">
                                {{ csrf_field() }}
                                <div class="row">
                                        ...
                                        <tr>
                                            <td>
                                                <a class="btn btn-outline-primary waves-effect waves-light"
                                                    href="{{ url('sales-document/product-decorate/report-preview/view') }}/{{ $dis->doc_id }}/{{ $dis->doc_status }}">
                                                    {{ $dis->doc_id }}
                                                </a>
                                            </td>
                                            ...
                                            <td>
                                                @php
                                                    if ($dis->sec_approve != null) {
                                                        $last = $dis->sec_approve;
                                                    } elseif ($dis->mn_approve != null) {
                                                        $last = $dis->mn_approve;
                                                    } else {
                                                        $last = '';
                                                    }
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".btnPrint").click(function() {
                ...
                $("#pdf").attr("src",
                    "{{ url('sales-document/discount-mistake/productdiscount/print') }}/" + objData
                    .toString());
                $.ajax({
                    type: 'POST',
