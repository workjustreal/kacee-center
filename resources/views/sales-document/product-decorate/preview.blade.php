    ...
    <div class="container-fluid">
        ...
        <div class="row">
                                ...
                                <div class="p-2">
                                    ...
                                    @if (
                                        $logact->description == 'ManagerApprove' ||
                                            ...
                                            $logact->description == 'Send Secretary' ||
                                            $logact->description == 'Secretary DisApprove' ||
                                            $logact->description == 'Secretary Comment')
                                        @if ($logact->description == 'ManagerApprove' || $logact->description == 'Send Secretary')
                                            @php
            ...
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-body">
                        @foreach ($result as $detail)
                            ...
                            @endif
                            <h5 class="text-center mb-3"><b><u>ใบคำขอสินค้าตกแต่งหน้าร้าน</u></b></h5>
                            <div class="card border ribbon-custom-box">
                                <div class="card-header">
                                    แบบฟอร์มขอสินค้าตกแต่งหน้าร้าน
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="full-underline abs row">
                                            ...
                                            <div class="row mt-2 mb-4">
                                                <div class="col-12 mb-1">
                                                    @if ($detail->request == 'ขอเพื่อสนับสนุนการขายโดยเสนอส่วนลด/ราคาพิเศษ')
                                                ...
                                                <div class="col-12 mb-1">
                                                    @if ($detail->request == 'ขอเพื่อสนับสนุนการขายโดยไม่คิดค่าใช้จ่าย')
                                                        <img src="{{ asset('assets/images/checkbox-mark.png') }}"
                                                            height="18">
                                                    @else
                                                        <img src="{{ asset('assets/images/checkbox.png') }}"
                                            ...
                                            @if ($detail->request == 'other')
                                                <div class="col-12">
                                                    <span class="full-dotted mb-3">
                                                        <span class="bg-white">คำขอเพิ่มเติม : </span>
                                                        <span class="text-dark px-3">
                                                            {{ $detail->note }}
                                                        </span>
                                                    </span>
                                            ...
                                            <div class="col-12">
                                                <span class="mb-5">
                                                    <span class="bg-white">รายละเอียดสินค้า : </span>
                                            ...
                                            <div class="col-12 mt-2">
                                                <span class="mb-5">
                                                    <span class="bg-white">หมายเหตุเพิ่มเติม : </span>
                                                    <span class="text-dark px-2">
                                                        {{ $detail->more }}
                                                    </span>
                                                </span>
                                        ...
                                        @foreach ($img as $key => $valimg)
                                            <div class="col-6 col-lg-2">
                                                <a href="javascript:void(0)">
                                                    <img src="{{ asset('assets/images/decorate/' . $valimg) }}"
                                                                ...
                                                                <div class="carousel-inner">
                                                                    @foreach ($img as $index => $slide)
                                                                        <div
                                                                            ...
                                                                            <a href="{{ asset('assets/images/decorate/' . $slide) }}"
                                                                                target="_blank">
                                                                                <img src="{{ asset('assets/images/decorate/' . $slide) }}"
                                                                                    class="d-block w-100"
                                                                                    alt="decorate image">
                                                                            </a>
                                                                        </div>
                ...
                @php
                    ...
                    foreach ($log as $applog) {
                        if ($applog->description == 'ManagerApprove') {
                            ...
                            $_mn_app_date[] = $thaiDateHelper->shortDateFormat($applog->updated_at);
                        } elseif ($applog->description == 'Send Secretary') {
                            $_manager = 'true';
                            $_mncomment[] = '<span class="text-success">(อนุมัติ)</span>' . ' ' . $applog->comment . '';
                            $_mn_app_date[] = $thaiDateHelper->shortDateFormat($applog->updated_at);
                        }
                        if ($applog->description == 'SecretaryApprove') {
                            ...
                            $_sec_app_date[] = $thaiDateHelper->shortDateFormat($applog->updated_at);
                                ...
                                <div class="card-body">
                                            ...
                                            @if ($mnfile->image_mn != '')
                                                ...
                                                <div class="row" id="old_image">
                                                    @foreach ($imgmn as $key => $mnval)
                                                        <div class="col-6 col-lg-2">
                                                            <a href="javascript:void(0)">
                                                                <img src="{{ asset('assets/images/decorate/' . $mnval) }}"
                                                                    class="w-100" alt="decorate image"
                                                                    title="decorate image" data-bs-toggle="modal"
                                                                        ...
                                                                        <div id="slideMn{{ $key }}"
                                                                            ...
                                                                            <div class="carousel-inner">
                                                                                @foreach ($imgmn as $index => $slideMn)
                                                                                    <div
                                                                                        class="carousel-item {{ $index == $key ? 'active' : '' }}">
                                                                                        <a href="{{ asset('assets/images/decorate/' . $slideMn) }}" target="_blank">
                                                                                            <img src="{{ asset('assets/images/decorate/' . $slideMn) }}"
                                                                                                class="d-block w-100"
                                                                                                alt="decorate image">
                                                                                        </a>
                                                                                    </div>
                                    ...
                                    @if ($status == 2)
                                        <form class="form-horizontal" method="post" id="managerForm"
                                            ...
                                            action="{{ route('decorate.managerApprove', [$detail->doc_id, $detail->id]) }}">
                                            {{ csrf_field() }}
                                        ...
                                        <form action="{{ route('decorate.image.request') }}" method="POST"
                                            ...
                                            class="dropzone" id="dropzone" data-plugin="dropzone">
                                            @csrf
                                            <div class="fallback">
                                        ...
                                        <div class="mt-2 d-grid gap-2 d-md-flex justify-content-md-start">
                                            <button type="button" id="managerapprove"
                                                onclick="managerApprove(),$('#approve').val('send')"
                                                class="btn btn-primary btn-rounded waves-effect waves-light">
                                                <span class="btn-label"><i class="mdi mdi-send"></i></span>ส่งให้เลขา
                                            </button>
                                            <button type="button" id="managerapprove"
                ...
                @endif
                @if (($status == 1 && Auth::User()->checkSecretary()) || ($status == 9 && $_secretary != '') || $status == 0)
                    <div class="card ribbon-box">
                        <div class="card-body">
                            <div class="card border">
                                <div class="card-header px-5">
...
@section('script')
    ...
    <script>
        ...
        function secretaryApprove(doc_id, id, approve) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    setTimeout(() => {
                        location.href =
                            "{{ url('sales-document/product-decorate/secretary-approve') }}";
                    }, 2000);
                }
            });
        }
        ...
        $("#btnPrint").click(function() {
            ...
            $("#pdf").attr("src", "{{ url('sales-document/product-decorate/print') }}/" + objData
                .toString());
            $.ajax({
                type: 'POST',
                url: "{{ route('decorate.log.print') }}",
                data: {
                    doc_id: $(this).val(),
                },
