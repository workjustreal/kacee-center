        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="get" action="{{ route('secretary.approve') }}">
                            {{ csrf_field() }}
                            <div class="row">
                                ...
                                @foreach ($discount as $dis)
                                    @if ($dis->doc_status != 1)
                                        ...
                                        <tr>
                                            ...
                                            <td><i class="mdi mdi-file-document-outline"></i> {{ $dis->product_list }}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @elseif($dis->doc_status == 9)
                                                    <span class="badge badge-soft-success">อนุมัติแล้ว</span>
                                                @endif
                                            </td>
                                            <td><a
                                                    href="{{ url('sales-document/discount-mistake/productdiscount-preview/view') }}/{{ $dis->doc_id }}/{{ $dis->doc_status }}">
