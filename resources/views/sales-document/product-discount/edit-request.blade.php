                    ...
                    <div class="card-body">
                        @foreach ($result as $req)
                            <form class="form-horizontal" method="post" enctype="multipart/form-data" id="request_update"
                                action="{{ route('update.Request', [$req->doc_id, $req->id, $req->doc_status]) }}">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-11 @if ($status != 2) mistake @endif">
                                        <div class="row">
                                            <div class="col-lg-5 mt-3">
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="radio" name="mistake"
                                                        id="mistake01" value="ความผิดพลาดจากการผลิตสินค้า"
                                                        @if ($req->mistake == 'ความผิดพลาดจากการผลิตสินค้า') checked @endif>
                                            ...
                                            <div class="col-lg-6 mt-3">
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="radio" name="mistake"
                                                        ...
                                                        @if ($req->mistake == 'ความผิดพลาดจากการรับคำสั่งซื้อ') checked @endif>
                                                    <label class="form-check-label"
                                            ...
                                            <div class="col-lg-5 mt-2">
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="radio" name="mistake"
                                                        ...
                                                        @if ($req->mistake == 'ความผิดพลาดจากการขนส่งสินค้า') checked @endif>
                                                    <label class="form-check-label"
                                            ...
                                            <div class="col-lg-6 mt-2">
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="radio" name="mistake"
                                                        ...
                                                        @if ($req->mistake == 'ความผิดพลาดจากสินค้าและอุปกรณ์') checked @endif>
                                                    <label class="form-check-label"
                                            ...
                                            <div class="col-lg-5 mt-2">
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="radio" name="mistake"
                                                        ...
                                                        @if ($req->mistake == 'ความผิดพลาดที่เกิดจากลูกค้าเอง') checked @endif>
                                                    <label class="form-check-label"
                                            ...
                                            <div class="col-lg-6 mt-2">
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="radio" name="mistake"
                                                        ...
                                                        @if ($req->mistake == 'other') checked @endif>
                                ...
                                <div @if ($edit == false) class="read" @endif>
                                    <div class="col-lg-12 mt-2">
                                        <div class="fom-group f_comment" @if ($req->note == '') hidden @endif>
                                    ...
                                    <div class="col-lg-12 mt-2">
                                        <div class="form-group ">
                                            ...
                                            <input type="text"
                                                class="form-control form-control-md form-control-required" id="invoice"
                                                name="invoice" placeholder="กรุณากรอกเลขที่ IV"
                                                value="{{ $req->invoice }}" required="">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 mt-2">
                                        <div class="form-group ">
                                    ...
                                    <div class="col-lg-12 mt-2">
                                        <div class="form-group ">
                                            <label class="control-label">ยอดเงินที่ขอชดเชย /
                                                ค่าเสียหายที่ลูกค้าร้องขอ</label>
                                            <input type="text"
                                                class="form-control form-control-md form-control-required"
                                                id="customer_request" name="customer_request"
                                                placeholder="กรุณากรอกชื่อเจ้าหน้าที่"
                                                value="{{ $req->customer_request }}" required="">
                                        </div>
                                    </div>
                                </div>
                                @php
                                    ...
                                    <div class="col-lg-12 mt-3">
                                        <div class="fom-group">
                                            ...
                                            <textarea class="form-control form-control-md form-control-required" id="description" name="description"
                                                placeholder="..." rows="7">{{ $req->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                @if ($ck_again == 'true')
                                        ...
                                        @if ($img != '')
                                            @foreach ($img as $img)
                                                <div class="col-2 mt-2">
                                                    <img src="{{ asset('assets/images/discount/' . $img) }}"
