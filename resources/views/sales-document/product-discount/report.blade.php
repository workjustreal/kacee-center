@extends('layouts.master-layout', ['page_title' => 'รายงานส่วนลดงานผิดพลาด'])
@section('css')
    <!-- third party css -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">รายงานส่วนลดงานผิดพลาด</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <form method="get" action="{{ route('discount.report') }}">
                                {{ csrf_field() }}
                                <div class="row">
                                        ...
                                        <tr>
                                            <td>
                                                <a class="btn btn-outline-primary waves-effect waves-light"
                                                    href="{{ url('sales-document/discount-mistake/report-preview/view') }}/{{ $dis->doc_id }}/{{ $dis->doc_status }}">
                                                    {{ $dis->doc_id }}
                                                </a>
                                            </td>
