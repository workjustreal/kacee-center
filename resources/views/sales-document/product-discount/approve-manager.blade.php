...
@section('content')
    <div class="container-fluid">
                            ...
                            <tr>
                                <td>
                                    <a class="btn btn-outline-primary waves-effect waves-light"
                                        href="{{ url('sales-document/discount-mistake/productdiscount-preview/view') }}/{{ $wa->doc_id }}/{{ $wa->doc_status }}">
                                        {{ $wa->doc_id }}
                                    </a>
                                </td>
                                ...
                                <td><i class="mdi mdi-file-document-outline"></i> {{ $wa->product_list }}</td>
                                <td>{{ $wa->customer_request }}</td>
                                <td>
                                ...
                                <td>
                                    ...
                                    @if (is_int($admin_manager))
                                        ...
                                        <a href="javascript: void(0);"
                                            ...
                                            <i class="mdi mdi-close-circle-outline fs-4 text-danger" title="ไม่อนุมัติ"></i>
                                        </a>
                                    @endif
                                </td>
                            </tr>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="get" action="{{ route('manger.approve') }}">
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        @foreach ($discount as $dis)
                            @if ($dis->doc_status != 2)
                                ...
                                <tr>
                                    ...
                                    <td><i class="fe-clock"></i> {{ $thaiDateHelper->shortDateFormat($dis->created_at) }}
                                    </td>
                                    @php
                                    ...
                                    <td>
                                        @if ($dis->doc_status == 9)
                                            <!-- Modal -->
                                            <div class="modal fade" id="historyPrint{{ $dis->id }}" tabindex="-1"
    ...
    <script>
        ...
        function approve(doc_id, id, approve) {
            ...
            Swal.fire({
                ...
                html: '<label>ความคิดเห็น</label><input type="text" class="form-control" id="comment" name="comment">',
                ...
                preConfirm: () => {
                    ...
                    return fetch(
                            '/sales-document/discount-mistake/approve/product-discount-repair/manager-approve', {
                                method: 'POST',
                                headers: {
