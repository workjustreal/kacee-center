@extends('layouts.master-layout', ['page_title' => "ยอดขายรายเดือน"])
@section('css')
<!-- third party css -->
                        ...
                        <table id="table"
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th data-field="daily_category" data-sortable="true">หมวดหมู่</th>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function ajaxRequest(params) {
            $(".btn-export").hide();
            var url = "{{ route('sr.monthly_sales.search') }}";
        ...
        function getSummary() {
            $.ajax({
                url: "{{ route('sr.monthly_sales.summary') }}",
                method: 'GET',
        ...
        function print() {
            var url = '{{ url("sales-report/monthly-sales/print") }}';
        ...
        function exportExcel() {
            var url = '{{ url("sales-report/monthly-sales/export") }}';
