@extends('layouts.master-layout', ['page_title' => "ยอดขายรายเดือน (แยกกลุ่มลูกค้า)"])
@section('css')
<!-- third party css -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">ยอดขายรายเดือน (แยกกลุ่มลูกค้า)</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-lg-auto col-md-auto col-sm-12 mb-2">
                                        <label for="daily_category">หมวดหมู่</label>
                                    ...
                                    <div class="col-lg-auto col-md-auto col-sm-12 mb-2">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control month-datepicker" id="doc_date" name="doc_date" placeholder="เลือกเดือน">
                                        </div>
                                    </div>
                                    <div class="col-lg-auto col-md-auto col-sm-12 mb-2">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".month-datepicker").flatpickr({
                ...
                disable: [
                    function (dateObject) {
                        var enabledYear = "2022";
                        var date = dateObject;
                        date.setDate(date.getDate() + 1);
                        if (date.toISOString().slice(0, 4) === new Date(enabledYear).toISOString().slice(0, 4)) {
                            return false;
                        }
                        return true;
                    }
        ...
        function ajaxRequest(params) {
            $(".btn-export").hide();
            var url = "{{ route('sr.monthly_sales_customer.search') }}";
        ...
        function print() {
            var url = '{{ url("sales-report/monthly-sales-customer/print") }}';
        ...
        function exportExcel() {
            var url = '{{ url("sales-report/monthly-sales-customer/export") }}';
