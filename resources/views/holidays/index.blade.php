@extends('layouts.master-layout', ['page_title' => "วันหยุดประจำปี"])
@section('css')
<!-- third party css -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">วันหยุดประจำปี</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <div class="row justify-content-between mb-2">
                        ...
                        <div class="col-auto">
                            <div class="mb-2 text-sm-end">
                                <a href="{{ url('holidays/create') }}" class="btn btn-primary waves-effect waves-light">
                                    <i class="mdi mdi-plus-circle me-1"></i> เพิ่มวันหยุดประจำปี </a>
                            </div>
                        </div>
                    </div>
