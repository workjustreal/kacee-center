@extends('layouts.master-layout', ['page_title' => "เพิ่มวันหยุดประจำปี"])
@section('css')
<!-- third party css -->
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">เพิ่มวันหยุดประจำปี</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <form action="{{ route('holidays.store') }}" name="create-form" method="post" enctype="multipart/form-data" onsubmit="return SubmitForm(this);">
                    {{ csrf_field() }}
                    <div class="card-body ribbon-box">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control holiday-datepicker" id="start" name="start" value="{{ old('start') }}" required>
                                @if ($errors->has('start'))
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control holiday-datepicker" id="end" name="end" value="{{ old('end') }}" required>
                                @if ($errors->has('end'))
                                <span class="text-danger">กรุณากรอกข้อมูล</span>
                                @endif
                            </div>
                        ...
                        <button type="submit" class="btn btn-success waves-effect waves-light mt-3">บันทึก</button>
                    </div>
                </form>
            </div>
        </div>
