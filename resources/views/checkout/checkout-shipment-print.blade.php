            ...
            <table class="table table-sm" style="margin-top: 6px;">
                <thead class="thead-color text-start">
                    <tr>
                        ...
                        <th width="120">หมายเลขขนส่ง</th>
                        <th width="120">หมายเลขออเดอร์</th>
                        <th width="120">หมายเลข SO</th>
                        <th width="80">แพ็คเกจ</th>
                        <th>ร้านค้า</th>
                        <th>เวลา</th>
                    </tr>
                </thead>
        ...
        <div class="content table-responsive">
            <table class="table table-sm" style="margin-top: 2px;">
                <tbody>
                    ...
                    <tr>
                        <td width="80">{{ number_format($loop->index + 1) }}</td>
                        <td width="120">{{ $list->trackingnumber }}</td>
                        <td width="120">{{ $list->ordernumber }}</td>
                        <td width="120">{{ $list->so }}</td>
                        <td width="80">{{ $list->packaging_total }}</td>
                    ...
                    <tr class="thead-color">
                        <th colspan="7" class="text-center">สรุป</th>
                    </tr>
                    <tr class="thead-color">
                        <th width="80">ร้านค้า</th>
                        <th width="120">หมายเลขขนส่ง</th>
                        <th width="120">หมายเลขออเดอร์</th>
                        <th width="120">หมายเลข SO</th>
                        <th width="80">แพ็คเกจ</th>
                    ...
                    <tr>
                        <td>{{ $list->eplatform_name }}</td>
                        <td>{{ number_format($list->tracking_total) }}</td>
                        <td>{{ number_format($list->order_total) }}</td>
                        <td>{{ number_format($list->so_total) }}</td>
                        <td>{{ number_format($list->packaging_total) }}</td>
                        <td></td>
                        <td></td>
                    </tr>
                    @endforeach
