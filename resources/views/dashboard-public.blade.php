...
@section('css')
    <link href="{{ URL::asset('assets/css/calendar/fullcalendar.min.css') }} " rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('assets/css/calendar/toastr.min.css') }} " rel="stylesheet" type="text/css" />
...
@section('content')
    <div class="container-fluid">
                            ...
                            <div class="carousel-item @if($loop->index==0) active @endif" data-bs-interval="7000">
                                ...
                                <a href="{{url('/events/show', $list->id)}}" class="">
                                    <div class="d-block font-info" role="alert">
                                        <i class="mdi mdi-alert-circle-outline me-2"></i> <strong>{{ $list->title }}</strong><br><span class="text-nowrap">@php echo strip_tags($list->description, ["a"]); @endphp</span>
                                    </div>
                                </a>
                            </div>
                            @endforeach
        ...
        <div class="modal fade" id="calendarModal" tabindex="-1" role="dialog" aria-labelledby="fullWidthModalLabel"
            aria-hidden="true">
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="position-fixed bottom-0 px-2 py-3" style="z-index: 11">
            @else
            <div class="position-fixed bottom-0 end-0 px-2 py-3" style="z-index: 11">
            @endif
                <div class="toast fade show bg-white" role="alert" aria-live="assertive" aria-atomic="true" data-bs-toggle="toast">
                    <div class="toast-header">
                        <img src="{{URL::asset('assets/images/logo-sm.png')}}" alt="brand-logo" height="12" class="me-1" />
                        <strong class="me-auto">Kacee Application</strong>
                        <small>คุณยังไม่ได้เข้าสู่ระบบ</small>
                        <button type="button" class="btn-close ms-2" data-bs-dismiss="toast" aria-label="Close"></button>
                    </div>
                    <div class="toast-body">
                        <div class="d-flex justify-content-center">
                            <a type="button" class="btn btn-danger btn-sm" href="{{ route('login') }}">เข้าสู่ระบบ</a>
                        </div>
                    </div>
                </div>
            </div>
