@extends('layouts.master-layout', ['page_title' => "แก้ไขพื้นที่การขาย"])
@section('content')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">แก้ไขพื้นที่การขาย</li>
                    </ol>
                </div>
                <h4 class="page-title">แก้ไขพื้นที่การขาย</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-box">
                        <form action="{{ route('sales-area.update') }}" class="wow fadeInLeft" method="POST"
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-required bg-light" id="area_code"
                                            name="area_code" value="{{ $area->area_code }}" autocomplete="off" minlength="4" maxlength="4" required readonly />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select form-control-required" id="dept_id" name="dept_id" required>
                                            ...
                                            <option value="{{ $list->dept_id }}" @if($area->dept_id==$list->dept_id) selected @endif>{{ $list->dept_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="area_description"
                                            name="area_description" value="{{ $area->area_description }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
