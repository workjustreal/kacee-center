@extends('layouts.master-layout', ['page_title' => "แก้ไขสิทธิ์การอนุมัติ (ตามหน่วยงาน)"])
@section('css')
<!-- third party css -->
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">แก้ไขสิทธิ์การอนุมัติ (ตามหน่วยงาน)</li>
                    </ol>
                </div>
                <h4 class="page-title">แก้ไขสิทธิ์การอนุมัติ (ตามหน่วยงาน)</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-box">
                        <form action="{{ route('authorization.update') }}" class="wow fadeInLeft" method="POST"
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    ...
                                    <select class="form-control form-control-required" data-toggle="select2" id="dept_id" name="dept_id" required>
                                        ...
                                        <optgroup label="ส่วน">
                                            ...
                                            <option value="{{ $list->dept_id }}" @if($authorization->dept_id==$list->dept_id) selected @endif>{{ $list->dept_name }} ({{ $list->dept_id }})</option>
                                            @endforeach
                                        </optgroup>
                                        <optgroup label="ฝ่าย">
