@extends('layouts.master-layout', ['page_title' => "เพิ่มสิทธิ์การอนุมัติลางาน (รายบุคคล)"])
@section('css')
<!-- third party css -->
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">เพิ่มสิทธิ์การอนุมัติลางาน (รายบุคคล)</li>
                    </ol>
                </div>
                <h4 class="page-title">เพิ่มสิทธิ์การอนุมัติลางาน (รายบุคคล)</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-box">
                        <form action="{{ route('authorization-manual.store') }}" class="wow fadeInLeft" method="POST"
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-12">
                                            <input type="text" class="form-control bg-light" id="emp_name" name="emp_name" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
