@extends('layouts.master-layout', ['page_title' => "เพิ่มข้อมูลตำแหน่งงาน"])
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-box">
                        <form action="{{ route('position.store') }}" class="wow fadeInLeft" method="POST"
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-required" id="position_id"
                                            name="position_id" value="{{ old('position_id') }}" autocomplete="off" minlength="3" maxlength="3" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="position_name_en"
                                            name="position_name_en" value="{{ old('position_name_en') }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
