@extends('layouts.master-layout', ['page_title' => "ดูข้อมูลตำแหน่งงาน"])
@section('content')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">ดูข้อมูลตำแหน่งงาน</li>
                    </ol>
                </div>
                <h4 class="page-title">ดูข้อมูลตำแหน่งงาน</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="position_id"
                                            name="position_id" value="{{ $position->position_id }}" autocomplete="off" minlength="3" maxlength="3" required disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="position_name"
                                            name="position_name" value="{{ $position->position_name }}" required disabled />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-md-12 col-sm-12 pt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="position_name_en"
                                            name="position_name_en" value="{{ $position->position_name_en }}" disabled />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
