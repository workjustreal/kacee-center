@extends('layouts.master-layout', ['page_title' => "แก้ไขข้อมูลพนักงาน"])
@section('css')
    {{-- inputdate --}}
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('employee.update') }}" id="employee-form" class="wow fadeInLeft" method="POST"
                                        ...
                                        <div class="col-md-3 col-lg-2 pt-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control form-control-sm form-control-required" id="emp_id"
                                                    name="emp_id" value="{{ $employee->emp_id }}" readonly required />
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-2 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select-sm"
                                                    ...
                                                    <option value="{{ $list->branch_id }}" @if($employee->branch_id ==
                                                        $list->branch_id)
                                                        selected @endif>{{ $list->branch_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-2 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm form-control-required" aria-label=".form-select-sm"
                                                    ...
                                                    <option value="{{ $list->dept_id }}" @if($employee->dept_id == $list->dept_id) selected @endif>
                                        ...
                                        <div class="col-md-3 col-lg-2 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select-sm"
                                                    ...
                                                    <option value="{{ $area->area_code }}" @if($employee->area_code==$area->area_code) selected @endif>
                                                        {{ $area->area_code }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-3 col-lg-2 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm form-control-required" aria-label=".form-select-sm"
                                                    ...
                                                    <option value="{{ $list->position_id }}" @if($employee->position_id
                                                        ==
                                                        $list->position_id) selected @endif>{{ $list->position_name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-3 col-lg-2 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm form-control-required" aria-label=".form-select-sm"
                                                    ...
                                                    <option value="" selected="selected" disabled>-</option>
                                                    <option value="D" @if($employee->emp_type == 'D') selected
                                                        @endif>รายวัน</option>
                                                    <option value="M" @if($employee->emp_type == 'M') selected
                                        ...
                                        <div class="col-md-3 col-lg-2 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm form-control-required" aria-label=".form-select-sm"
                                                    ...
                                                    <option value="" selected="selected" disabled>-</option>
                                                    <option value="1" @if($employee->emp_status == '1') selected
                                                        @endif>ปกติ</option>
                                                    <option value="2" @if($employee->emp_status == '2') selected
                                                        @endif>ทดลองงาน</option>
                                                    <option value="0" @if($employee->emp_status == '0') selected
                                                        @endif>ลาออก</option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    <input type="text"
                                                        ...
                                                        value="{{\Carbon\Carbon::parse($employee->start_work_date)->format('d/m/Y')}}"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    <input type="text"
                                                        ...
                                                        value="@if($employee->end_work_date!='' && $employee->end_work_date!='0000-00-00'){{\Carbon\Carbon::parse($employee->end_work_date)->format('d/m/Y')}}@endif">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4 pt-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="detail"
                                                    name="detail" value="{{ $employee->detail }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    <input type="text"
                                                        ...
                                                        value="{{\Carbon\Carbon::parse($employee->birth_date)->format('d/m/Y')}}"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-lg-2 col-6 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select"
                                                    ...
                                                    <option value="" selected="selected" disabled>-</option>
                                                    <option value="ไทย" @if($employee->ethnicity == 'ไทย') selected
                                                        @endif>ไทย</option>
                                                    <option value="อื่นๆ" @if($employee->ethnicity == 'อื่นๆ') selected
                                                        @endif>อื่นๆ
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-lg-2 col-6 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select"
                                                    ...
                                                    <option value="" selected="selected" disabled>-</option>
                                                    <option value="ไทย" @if($employee->nationality == 'ไทย') selected
                                                        @endif>ไทย
                                                    </option>
                                                    <option value="อื่นๆ" @if($employee->nationality == 'อื่นๆ')
                                                        selected @endif>อื่นๆ
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-lg-2 col-6 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select"
                                                    ...
                                                    <option value="" selected="selected" disabled>-</option>
                                                    <option value="พุทธ" @if($employee->religion == 'พุทธ') selected
                                                        @endif>พุทธ
                                                    </option>
                                                    <option value="อิสลาม" @if($employee->religion == 'อิสลาม') selected
                                                        @endif>อิสลาม</option>
                                                    <option value="คริสต์" @if($employee->religion == 'คริสต์') selected
                                                        @endif>คริสต์</option>
                                                    <option value="ฮินดู" @if($employee->religion == 'ฮินดู') selected
                                                        @endif>ฮินดู
                                                    </option>
                                                    <option value="ซิกข์" @if($employee->religion == 'ซิกข์') selected
                                                        @endif>ซิกข์
                                                    </option>
                                                    <option value="ขงจื๊อ" @if($employee->religion == 'ขงจื๊อ') selected
                                                        @endif>ลัทธิขงจื๊อ</option>
                                                    <option value="ไม่มี" @if($employee->religion == 'ไม่มี') selected
                                                        @endif>ไม่มี
                                                    </option>
                                                    <option value="อื่นๆ" @if($employee->religion == 'อื่นๆ') selected
                                                        @endif>อื่นๆ
                                                    </option>
                                                    <option value="ไม่ระบุ" @if($employee->religion == 'ไม่ระบุ')
                                                        selected
                                        ...
                                        <div class="col-md-2 col-lg-2 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm form-control-required" aria-label=".form-select"
                                                    ...
                                                    <option value="" selected="selected" disabled>-</option>
                                                    <option value="M" @if($employee->gender == 'M') selected @endif>ชาย
                                                    </option>
                                                    <option value="F" @if($employee->gender == 'F') selected @endif>หญิง
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-lg-4 pt-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="name_en"
                                                    name="name_en" value="{{ $employee->name_en }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4 pt-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="surname_en"
                                                    name="surname_en" value="{{ $employee->surname_en }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4 pt-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-lg-4 pt-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm"
                                                    ...
                                                    value="{{ $employee->vehicle_registration }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 pt-2">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="3" class="form-control form-control-sm" id="address"
                                                    name="address" style="resize: none">{{ $employee->address }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4 col-6 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select"
                                                    ...
                                                    <option value="{{ $value }}" @if($employee->province == $value)
                                        ...
                                        <div class="col-md-2 col-lg-2 col-6 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select"
                                                    ...
                                                    <option value="{{ $value }}" @if($employee->district == $value)
                                                        selected @endif>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-2 col-lg-2 col-6 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select"
                                                    ...
                                                    @foreach ($tambons as $key => $value)
                                                    <option value="{{ $value }}" @if($employee->subdistrict == $value)
                                                        selected @endif>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-2 col-lg-2 col-6 pt-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control form-control-sm"
                                                    id="txtZipcode" name="zipcode" value="{{ $employee->zipcode }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-lg-2 col-6 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select"
                                                    ...
                                                    <option value="ไทย" @if($employee->country == 'ไทย') selected
                                                        @endif>ไทย</option>
                                                    <option value="เมียนมาร์" @if($employee->country == 'เมียนมาร์')
                                                        selected @endif>เมียนมาร์</option>
                                                    <option value="ลาว" @if($employee->country == 'ลาว') selected
                                                        @endif>ลาว</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 pt-2">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="3" class="form-control form-control-sm" id="current_address"
                                                    name="current_address" style="resize: none">{{ $employee->current_address }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4 col-6 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select"
                                                    ...
                                                    <option value="" selected="selected">เลือกจังหวัด</option>
                                                    @foreach ($changwats as $key => $value)
                                                    <option value="{{ $value }}" @if($employee->current_province == $value)
                                                        selected @endif>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-2 col-lg-2 col-6 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select"
                                                    ...
                                                    <option value="" selected>เลือกอำเภอ/เขต</option>
                                                    @foreach ($amphoes as $key => $value)
                                                    <option value="{{ $value }}" @if($employee->current_district == $value)
                                                        selected @endif>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-2 col-lg-2 col-6 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select"
                                                    ...
                                                    <option value="" selected>เลือกตำบล/แขวง</option>
                                                    @foreach ($tambons as $key => $value)
                                                    <option value="{{ $value }}" @if($employee->current_subdistrict == $value)
                                                        selected @endif>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-2 col-lg-2 col-6 pt-2">
                                            <div class="form-group">
                                                <label class="control-label">รหัสไปรษณีย์</label>
                                                <input type="number" class="form-control form-control-sm"
                                                    id="txtCurrentZipcode" name="current_zipcode" value="{{ $employee->current_zipcode }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-lg-2 col-6 pt-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-sm" aria-label=".form-select"
                                                    ...
                                                    <option value="ไทย" @if($employee->current_country == 'ไทย') selected
                                                        @endif>ไทย</option>
                                                    <option value="เมียนมาร์" @if($employee->current_country == 'เมียนมาร์')
                                                        selected @endif>เมียนมาร์</option>
                                                    <option value="ลาว" @if($employee->current_country == 'ลาว') selected
                                                        @endif>ลาว</option>
                                                </select>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    function SubmitForm(form){
        if (document.getElementById('emp_status').value == "0") {
            if (document.getElementById('end_work_date').value == "") {
                Swal.fire({
                    icon: "warning",
                    title: "ถ้าพนักงานลาออก<br>ต้องเลือกวันที่ออกงานด้วย",
