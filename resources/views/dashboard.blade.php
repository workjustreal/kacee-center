                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="avatar-lg rounded-circle bg-soft-primary border-white border">
                                        <i class="fe-search font-22 avatar-title text-white"></i>
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="text-end">
                                        <h3 class="text-white mt-3">ค้นหาสินค้า</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <a href="{{ url('/checkout/shipment') }}">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="text-end">
                                        <h3 class="text-white mt-3">เช็คเอาท์การจัดส่ง</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <a href="{{ url('/organization/employees') }}">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="text-end">
                                        <h3 class="text-white mt-3">ข้อมูลพนักงาน</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <a href="{{ url('/leave/dashboard') }}">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="text-end">
                                        <h3 class="text-white mt-3">ลางานออนไลน์</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <a href="{{ url('/organization/organizational-chart') }}">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="text-end">
                                        <h3 class="text-white mt-3">แผนผังองค์กร</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
