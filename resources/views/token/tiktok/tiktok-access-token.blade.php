    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-box">
                        <form class="form-horizontal" action="{{ route('token.tiktok.generate_access_token') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="mb-3">
                                <a class="btn btn-warning" href="{{ $link }}" target="_blank">Authorize Open Application</a>
                            </div>
