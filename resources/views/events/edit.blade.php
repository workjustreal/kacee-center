@extends('layouts.master-layout', ['page_title' => "แก้ไขประกาศบริษัท"])
@section('css')
<!-- third party css -->
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">แก้ไขประกาศบริษัท</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <form action="{{ route('events.update') }}" name="create-form" method="post" enctype="multipart/form-data" onsubmit="return SubmitForm(this);">
                    {{ csrf_field() }}
                    <div class="card-body ribbon-box">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                ...
                                <input type="hidden" class="form-control" id="id" name="id" value="{{ $event->id }}" required>
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control datepicker" id="start" name="start" value="{{ $event->start }}" required>
                                @if ($errors->has('start'))
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control datepicker" id="end" name="end" value="{{ $event->end }}" required>
                                @if ($errors->has('end'))
                                <span class="text-danger">กรุณากรอกข้อมูล</span>
                                @endif
                            </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="incalendar" name="incalendar" @if ($event->calendar==1) checked @endif>
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="show" name="show" @if ($event->status==1) checked @endif>
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="info" name="info" @if ($event->info==1) checked @endif>
                                    <label class="form-check-label" for="info">แจ้งเตือน</label>
                                </div>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-success waves-effect waves-light mt-3">อัปเดต</button>
                    </div>
                </form>
            </div>
        </div>
