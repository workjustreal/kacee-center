@extends('layouts.master-nopreloader-layout', ['page_title' => 'รายการบำรุงรักษาส่วนบุคคล'])
@section('css')
    <!-- third party css -->
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">แจ้งซ่อมรายบุคคล</li>
                        </ol>
                    </div>
                    {{-- <h4 class="page-title">เพิ่มรายการ</h4> --}}
                    <h4 class="page-title">การแจ้งซ่อมรายบุคคล 
                        <span style="font-size: 14px">
                            <a href="{{ asset('assets/files/manual/คู่มือแจ้งซ่อม.pdf') }}" target="_blank" rel="noopener noreferrer">
                                ( <i class="mdi mdi-file-document-outline text-primary"></i> คู่มือระบบแจ้งซ่อม)
                            </a>
                        </span>
                    </h4>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-3 hvr-bob">
                                <div class="widget-rounded-circle card bg-emp">
                                    <a href="{{ url('/repair/repair-form/A03050100') }}">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-4">
                                                    <div
                                                        class="avatar-lg rounded-circle bg-soft-primary border-white border">
                                                        <i class="fe-zap font-22 avatar-title text-white"></i>
                                                    </div>
                                                </div>
                                                <div class="col-8">
                                                    <div class="text-end">
                                                        <h3 class="text-white mt-3">ไฟฟ้าและสุขาภิบาล</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6 col-xl-3 hvr-bob">
                                <div class="widget-rounded-circle card bg-product">
                                    <a href="{{ url('/repair/repair-form/A03050200') }}">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-4">
                                                    <div
                                                        class="avatar-lg rounded-circle bg-soft-success border-white border">
                                                        <i class="fe-truck font-22 avatar-title text-white"></i>
                                                    </div>
                                                </div>
                                                <div class="col-8">
                                                    <div class="text-end">
                                                        <h3 class="text-white mt-3">ยานยนต์</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6 col-xl-3 hvr-bob">
                                <div class="widget-rounded-circle card bg-stock">
                                    <a href="{{ url('/repair/repair-form/A03060100') }}">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-4">
                                                    <div
                                                        class="avatar-lg rounded-circle bg-soft-warning border-white border">
                                                        <i class="fe-repeat font-22 avatar-title text-white"></i>
                                                    </div>
                                                </div>
                                                <div class="col-8">
                                                    <div class="text-end">
                                                        <h3 class="text-white mt-3">ซ่อมบำรุง</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6 col-xl-3 hvr-bob">
                                <div class="widget-rounded-circle card bg-Leave">
                                    <a href="{{ url('/repair/repair-form/A01100100') }}">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-4">
                                                    <div
                                                        class="avatar-lg rounded-circle bg-soft-danger border-white border">
                                                        <i class="fe-monitor font-22 avatar-title text-white"></i>
                                                    </div>
                                                </div>
                                                <div class="col-8">
                                                    <div class="text-end">
                                                        <h3 class="text-white mt-3">ไอที</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header bg-emp bg-soft-primary">
                        <h4 class="text-white">ใบแจ้งรายบุคคล</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-striped text-nowrap" id="table" data-toggle="table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="order_dept" data-sortable="true">แผนกงาน</th>
                                    <th data-field="order_type" data-sortable="true">ประเภทงาน</th>
                                    <th data-field="order_address" data-sortable="true">สถานที่ซ่อม</th>
                                    <th data-field="order_tool" data-sortable="true">อุปกรณ์ที่แจ้ง</th>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function ajaxRequest(params) {
            var url = "{{ route('repair.searchOnce') }}";
