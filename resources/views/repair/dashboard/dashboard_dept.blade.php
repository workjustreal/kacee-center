@extends('layouts.master-nopreloader-layout', ['page_title' => 'Dashboard Dept'])
@section('css')
    <!-- third party css -->
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">สรุปงานแจ้งซ่อมภายในแผนก</li>
                        </ol>
                    </div>
                    <h4 class="page-title">สรุปงานแจ้งซ่อมภายในแผนก</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                ...
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-auto col-md-auto col-sm-12 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control month-datepicker" autocomplete="off"
                                                id="doc_date" name="doc_date" placeholder="เลือกเดือนปี">
                                        </div>
                                    </div>
                                    <div class="col-lg-auto col-md-auto col-sm-12 mb-2">
                        ...
                        <table class="table table-striped text-nowrap" id="table" data-toggle="table"
                            ...
                            <thead>
                                <tr>
                                    <th data-field="dept_id" data-sortable="true">แผนกงาน</th>
                                    <th data-field="emp_id" data-sortable="true">พนักงาน</th>
                                    <th class="text-center" data-field="count_orderProcess" data-sortable="true">งานที่กำลังดำเนินการ</th>
                                    <th class="text-center" data-field="count_orderSuccess" data-sortable="true">งานที่เสร็จสิ้น</th>
                                    <th class="text-center text-danger" data-field="count_orderAll" data-sortable="true">รวมงานต่อเดือน</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function ajaxRequest(params) {
            var url = "{{ route('repair.dashboard.searchDept') }}";
            setTimeout(() => {
