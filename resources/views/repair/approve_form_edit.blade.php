                                                ...
                                                <div class="col-md-6 col-lg-5 pt-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date"
                                                            ...
                                                            value="{{ $repairs->start_date }}" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            @if ($repairs->order_dept == 'A03050200')
                                                    ...
                                                    <div class="col-md-6 col-lg-5 pt-2">
                                                        <div class="form-group ">
                                                            ...
                                                            <select
                                                                ...
                                                                <option value="อี.แอนด์ วี."
                                                                    @if ($repairs->order_address == 'อี.แอนด์ วี.') selected @endif>
                                                                    @php $chk = true; @endphp
                                                                    อี.แอนด์ วี.</option>
                                                                <option value="ดี ธวัชชัย"
                                                                    @if ($repairs->order_address == 'ดี ธวัชชัย') selected @endif>
                                                                    @php $chk = true; @endphp
                                                                    ดี ธวัชชัย</option>
                                                                <option value="ช.การยาง"
                                                                    @if ($repairs->order_address == 'ช.การยาง') selected @endif>
                                                                    @php $chk = true; @endphp
                                                                    ช.การยาง</option>
                                                                <option value="NT การาจ"
                                                                    @if ($repairs->order_address == 'NT การาจ') selected @endif>
                                                                    @php $chk = true; @endphp
                                                                    NT การาจ</option>
                                                                <option value="อู่ธนกร"
                                                                    @if ($repairs->order_address == 'อู่ธนกร') selected @endif>
                                                                    @php $chk = true; @endphp
                                                                    อู่ธนกร</option>
                                                                <option value="ศูนย์ TOYOTA"
                                                                    @if ($repairs->order_address == 'ศูนย์ TOYOTA') selected @endif>
                                                                    @php $chk = true; @endphp
                                                                    ศูนย์ TOYOTA</option>
                                                                <option value="ศูนย์ ISUZU"
                                                                    @if ($repairs->order_address == 'ศูนย์ ISUZU') selected @endif>
                                                                    @php $chk = true; @endphp
                                                                    ศูนย์ ISUZU</option>
                                                                <option value="other"
                                                                    @if ($chk == false) selected @endif>
                                                                    อื่นๆ...</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-lg-5 pt-2" id="ifYes"
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" class="form-control form-control-md"
                                                                ...
                                                                value="{{ $repairs->order_address }}" autocomplete="off">
                                                            {{-- @endif --}}
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <select name="technician_name[]" multiple="multiple"
                                                            ...
                                                            @foreach ($empname_parent as $row)
                                                                ...
                                                                <option
                                                                    ...
                                                                    @if ($tech_name) @foreach ($tech_name as $rowt)
                                                                            @if ($rowt['emp_id'] == $row->emp_id)
                                                                                selected @endif
                                                                    @endforeach
                                                            @endif
                                                            >{{ $worker }}
                                                            ...
                                                            @endforeach
                                                            @if ($tech_name)
                                                                @foreach ($tech_name as $rowt)
                                                                    <h5 class="mb-2">ผู้ปฏิบัติงานคนที่
                                                                        {{ $loop->index + 1 }} :
                                                                        <span
                                                                            class="text-primary me-2">{{ $rowt['name'] . ' ' . $rowt['surname'] }}</span>
                                                                    </h5>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                ...
                                                <div class="col-md-6 col-lg-5 pt-2">
                                                    <div class="fom-group ">
                                                        ...
                                                        <textarea class="form-control form-control-md form-control-required" id="manager_detail" name="manager_detail"
                                                            placeholder="หมายเหตุ" required="" rows="4">{{ $repairs->manager_detail }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
