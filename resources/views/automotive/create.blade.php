                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card border">
                            <div class="card-header"><b>เพิ่มข้อมูลรถ</b></div>
                            <div class="card-body">
                                @if ($errors->any())
                                        ...
                                        <div class="col-md-9 col-lg-5 pt-2">
                                            <div class="form-group ">
                                                ...
                                                <select class="form-select form-select-md form-control-required"
                                                    ...
                                                    onchange="getModel(this);" required="">
                                        ...
                                        <div class="col-md-9 col-lg-5 pt-2">
                                            <div class="form-group ">
                                                ...
                                                {{-- <select class="selectize-programmatic" aria-label=".form-select-md"
                                                    ...
                                                    @foreach ($department as $list)
                                                        <option value="{{ $list->dept_id }}"
                                                            @if (old('dept_id') == $list->dept_id) selected @endif>
                                                            @if ($list->level == '0')
                                                                *
                                                            @endif
                                                            @if ($list->level == '1')
                                                ...
                                                <input type="text" name="dept_id" id="dept_id"
                                                    class="form-control form-control-md form-control-required"
                                                    autocomplete="off" required="" placeholder="กรุณากรอกฝ่าย/แผนก" />
                                        ...
                                        <div class="col-md-9 col-lg-5 pt-2">
                                            <div class="fom-group ">
                                                ...
                                                <textarea class="form-control form-control-md form-control-required" id="car_detail" name="car_detail"
                                                    placeholder="..." rows="2" value=""></textarea>
                                            </div>
                                        </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var route = "{{ route('automotive.searchAuto') }}";
        $("#dept_id").typeahead({
            minLength: 1,
            items: 10,
            showHintOnFocus: "all",
            ...
            afterSelect: function(item) {
                this.$element[0].value = item.dept_id;
                console.log(item);
            },
