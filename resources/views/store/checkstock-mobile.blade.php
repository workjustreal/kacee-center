                        ...
                        <div class="col-md-4 col-sm-12 mb-2">
                            <div class="input-group">
                                <input type="text" class="form-control border border-primary" id="search" name="search"
                                    ...
                                    autocomplete="off" style="text-transform: uppercase;" onclick="$(this).select();$(this).attr('inputmode', 'none');" onfocus="$(this).css('background', 'yellow');" onblur="$(this).css('background', 'white');" inputmode="none">
                                <button type="button" class="btn btn-outline-secondary border border-primary"
                                    id="btn-keyboard" onclick="toggle_keyboard();"><i class="fas fa-keyboard"
                                    ...
                                    <table id="tableContent" class="table table-hover table-bordered">
                                        <thead class="bg-primary text-white border border-primary">
                                            <tr>
                                                ...
                                                <th style="width: 430px;" class="text-center">สินค้า</th>
